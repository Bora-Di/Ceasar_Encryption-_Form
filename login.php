...
if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    // Encrypt the password
    $encryptedPassword = caesarEncrypt($password, 5); // Use the Caesar cipher with a shift of 3

    // Insert user data into the database
    $sql = "INSERT INTO usertest (username, email, encrypted_password) VALUES ('$username', $email, '$encryptedPassword')";
